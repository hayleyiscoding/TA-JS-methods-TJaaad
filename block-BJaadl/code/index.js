...
let withVowels = words.filter((word) => checkVowel(word));
...
let noVowelStart = words.filter((word) => !checkVowel(word[0]));

// - Create a new array that contianse words not ending with vowel

let noVowelEnd = words.filter((word) => !checkVowel(word[word.length -1]));
