...
totalFruits.forEach(function(fruit) {
    console.log(fruit.toLowerCase());
})

// Convert all fruits name into lowercase and store in new array named lowercaseFruits

let lowercaseFruits = totalFruits.forEach(function(fruit) {
    fruit.toLowerCase();
})
...
let oddNumbers = numbersThree.map(function(number){
    return (number % 2 !== 0);
})
...
let evenNumbers = numbersThree.map(function(number){
    return (number % 2 === 0);
})
